              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="aa-header-left">
                  ...
                  <div class="aa-email hidden-xs">
                    <span class="fa fa-envelope-o"></span> baytkom@realstate.org
                  </div>
                </div>              
              </div>
              <div class="col-md-6 col-sm-6 col-xs-6">
    ...
    <div class="aa-slider-area"> 
      ...
      <div class="aa-top-slider">
        ...
        <div class="aa-top-slider-single">
          <img src="img/slider/22.jpg" alt="img">
          <!-- Top slider content -->
        ...
        <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="img/slider/21.jpg" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <div class="aa-latest-properties-content">
          <div class="row">
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="img/item/1.jpeg" alt="img">
                </a>
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="img/item/2.jpeg" alt="img">
                </a>
              ...
              <ul class="aa-agents-slider">
                ...
                <li>
                 ...
                 <li>
                  <div class="aa-single-agents">
                    <div class="aa-agents-img">
                      <img src="img/agents/agent-6.png" alt="agent member image">
                    </div>
                    <div class="aa-agetns-info">
                      <h4><a href="#">Waleed Taha</a></h4>
                      <span>Top Agent</span>
                      <div class="aa-agent-social">
                        <a href="#"><i class="fa fa-facebook"></i></a>
                        <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <li>
                  <div class="aa-single-agents">
                    <div class="aa-agents-img">
                      <img src="img/agents/agent-7.png" alt="agent member image">
                    </div>
                    <div class="aa-agetns-info">
